...
public class ChainController {
    ...
    public void handleFileUpload(@RequestParam("file") MultipartFile file,
        ...
        chainService.savePreview(restaurantId, (String) uploadResult.get("url"));
...
//        }
    ...
    public ResponseEntity<Void> deleteChain(@PathVariable Long id) {
        ...
        return ResponseEntity.ok().headers(HeaderUtil.createEntityDeletionAlert("chain", id.toString())).build();
    }
